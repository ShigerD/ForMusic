...
public class DiscView extends RelativeLayout {
    ...
    private Bitmap getMusicPicBitmap(int musicPicSize, String musicPicRes) {
        ...
        BitmapFactory.decodeResource(getResources(),R.drawable.back_add_playlist,options);
    ...
    public void setMusicDataList(List<MusicData> musicDataList) {
        ...
        for (MusicData musicData : mMusicDatas) {
            ...
            disc.setImageDrawable(getDiscDrawable(musicData.getMusicAlbumPicPath()));
        ...
        if (mIPlayInfo != null) {
            mIPlayInfo.onMusicInfoChanged(musicData.getMusicName(), musicData.getMusicPlayer());
            mIPlayInfo.onMusicPicChanged(musicData.getMusicAlbumPicPath());
        }
    }
